...
- **Capability-aware Volume Refresh:** When `SwitchAudioSource` is absent, the volume popup skips unusable output-route discovery while preserving Now Playing refresh and hidden route rows.
