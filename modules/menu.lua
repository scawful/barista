...
function menu.render_front_app(ctx)
  ...
  local front_app_menu = {
    ...
    { type = "separator", name = "front_app.menu.sep1" },
    ...
    { type = "item", name = "front_app.menu.space.enable", icon = "󰆾", label = "Enable BSP Tiling", action = ctx.call_script(ctx.scripts.space_mode, "current", "bsp") },
    ...
    { type = "item", name = "front_app.menu.space.emacs", icon = "󰘔", label = "Focus Emacs Space", action = ctx.call_script(ctx.scripts.yabai_control, "space-focus-app", "Emacs") },
  }
