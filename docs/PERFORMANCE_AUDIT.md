...
*   **Update:**
    ...
    - actionable Top CPU now replaces the duplicate standalone Activity Monitor row while enabled; disabling Top CPU restores the static action without changing the metric allowlist
